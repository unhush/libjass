...
(function (root, factory) {
    ...
    function (module, exports, __webpack_require__) {
        exports.settings = __webpack_require__(1);
        var set = __webpack_require__(4);
        var map = __webpack_require__(6);
        var promise = __webpack_require__(5);
        exports.DeferredPromise = promise.DeferredPromise;
        exports.webworker = __webpack_require__(2);
        exports.parts = __webpack_require__(7);
        exports.parser = __webpack_require__(3);
        exports.renderers = __webpack_require__(10);
        exports.ASS = __webpack_require__(8);
        exports.Dialogue = __webpack_require__(9);
        exports.ScriptProperties = __webpack_require__(11);
        exports.Style = __webpack_require__(12);
        var types = __webpack_require__(13);
        exports.BorderStyle = types.BorderStyle;
        exports.Format = types.Format;
        exports.WrappingStyle = types.WrappingStyle;
        Object.defineProperties(exports, {
            debugMode: {
                get: function () {
                    return exports.settings.debugMode;
                },
                set: function (value) {
                    return exports.settings.debugMode = value;
                }
            },
            verboseMode: {
                get: function () {
                    return exports.settings.verboseMode;
                },
                set: function (value) {
                    return exports.settings.verboseMode = value;
                }
            },
            Set: {
                get: function () {
    ...
    function (module, exports, __webpack_require__) {
        var map = __webpack_require__(6);
        var promise = __webpack_require__(5);
        var DeferredPromise = promise.DeferredPromise;
        ...
        exports._registerWorkerCommand = _registerWorkerCommand;
        /**
        ...
        exports._registerClassPrototype = _registerClassPrototype;
        var _scriptNode = null;
        if (typeof document !== "undefined" && document.currentScript !== undefined) {
            _scriptNode = document.currentScript;
        }
        var workerCommands = new map.Map();
        var classPrototypes = new map.Map();
        /**
        ...
        var WorkerChannelImpl = function () {
            function WorkerChannelImpl(_comm) {
                var _this = this;
                this._comm = _comm;
                this._pendingRequests = new map.Map();
    ...
    function (module, exports, __webpack_require__) {
        var parts = __webpack_require__(7);
        var globalSettings = __webpack_require__(1);
        var ASS = __webpack_require__(8);
        var Style = __webpack_require__(12);
        var Dialogue = __webpack_require__(9);
        var map = __webpack_require__(6);
        var promise = __webpack_require__(5);
        var DeferredPromise = promise.DeferredPromise;
        /**
        ...
        var StringStream = function () {
            ...
            StringStream.prototype.nextLine = function () {
                ...
                if (this._readTill < this._str.length) {
                    ...
                    result = promise.Promise.resolve(null);
                }
                return result;
            };
            return StringStream;
        ...
        var XhrStream = function () {
            ...
            XhrStream.prototype.nextLine = function () {
                ...
                var deferred = this._pendingDeferred = new DeferredPromise();
        ...
        var StreamParser = function () {
            function StreamParser(_stream) {
                var _this = this;
                this._stream = _stream;
                this._ass = new ASS();
                this._minimalDeferred = new DeferredPromise();
        ...
        var SrtStreamParser = function () {
            function SrtStreamParser(_stream) {
                var _this = this;
                this._stream = _stream;
                this._ass = new ASS();
                this._deferred = new DeferredPromise();
            ...
            SrtStreamParser.prototype._onNextLine = function (line) {
                ...
                if (line === null) {
                    if (this._currentDialogueNumber !== null && this._currentDialogueStart !== null && this._currentDialogueEnd !== null && this._currentDialogueText !== null) {
                        this._ass.dialogues.push(new Dialogue(new map.Map([ [ "Style", "Default" ], [ "Start", this._currentDialogueStart ], [ "End", this._currentDialogueEnd ], [ "Text", this._currentDialogueText ] ]), this._ass));
                    }
                    this._deferred.resolve(this._ass);
                    return;
                }
        ...
        var webworker = __webpack_require__(2);
        webworker._registerWorkerCommand(1, function (parameters, response) {
            var result;
            try {
    ...
    function (module, exports) {
        ...
        var SimplePromise = function () {
            function SimplePromise(_resolver) {
                var _this = this;
            ...
            SimplePromise._nextTick = function () {
                ...
                if (global.process !== undefined && typeof global.process.nextTick === "function") {
                    ...
                    var observer = new MutationObserver(function () {
                        ...
                        pending = [];
                        processing.forEach(function (callback) {
                            return callback();
                        });
    ...
    function (module, exports, __webpack_require__) {
        exports.drawing = __webpack_require__(14);
        /**
        ...
        var VectorClip = function () {
            function VectorClip(_scale, _instructions, _inside) {
                this._scale = _scale;
        ...
        var DrawingInstructions = function () {
            function DrawingInstructions(_instructions) {
                this._instructions = _instructions;
            }
        ...
        Object.keys(exports.drawing).forEach(function (key) {
            var value = exports.drawing[key];
            if (value instanceof Function) {
    ...
    function (module, exports, __webpack_require__) {
        var Dialogue = __webpack_require__(9);
        var Style = __webpack_require__(12);
        var ScriptProperties = __webpack_require__(11);
        var types = __webpack_require__(13);
    ...
    function (module, exports, __webpack_require__) {
        var types = __webpack_require__(13);
        var valueOrDefault = types.valueOrDefault;
        var parser = __webpack_require__(3);
        var parts = __webpack_require__(7);
        var globalSettings = __webpack_require__(1);
        /**
        ...
        var Dialogue = function () {
            function Dialogue(template, ass) {
                ...
                this._layer = Math.max(valueOrDefault(template, "Layer", parseInt, function (value) {
                    return !isNaN(value);
                }, "0"), 0);
            ...
            Dialogue.prototype._parsePartsString = function () {
                var _this = this;
                this._parts = parser.parse(this._rawPartsString, "dialogueParts");
                ...
                this._parts.forEach(function (part, index) {
                    if (part instanceof parts.Alignment) {
                        ...
                        if (movePart.t1 === null || movePart.t2 === null) {
                            _this._parts[index] = new parts.Move(movePart.x1, movePart.y1, movePart.x2, movePart.y2, 0, _this._end - _this._start);
                        }
                        ...
                        if (transformPart.start === null || transformPart.end === null || transformPart.accel === null) {
                            _this._parts[index] = new parts.Transform(transformPart.start === null ? 0 : transformPart.start, transformPart.end === null ? _this._end - _this._start : transformPart.end, transformPart.accel === null ? 1 : transformPart.accel, transformPart.tags);
                        }
                    }
                });
                if (globalSettings.debugMode) {
    ...
    function (module, exports, __webpack_require__) {
        var clocks = __webpack_require__(15);
        exports.EventSource = clocks.EventSource;
        exports.ClockEvent = clocks.ClockEvent;
        exports.ManualClock = clocks.ManualClock;
        exports.VideoClock = clocks.VideoClock;
        exports.DefaultRenderer = __webpack_require__(17);
        exports.NullRenderer = __webpack_require__(16);
        exports.WebRenderer = __webpack_require__(19);
        exports.RendererSettings = __webpack_require__(18);
    }, /* 11 */
    function (module, exports) {
        /**
        ...
        module.exports = ScriptProperties;
    }, /* 12 */
    function (module, exports, __webpack_require__) {
        var types = __webpack_require__(13);
        var valueOrDefault = types.valueOrDefault;
        ...
        var Style = function () {
            function Style(template) {
                ...
                this._fontSize = valueOrDefault(template, "Fontsize", parseFloat, function (value) {
                    return !isNaN(value);
                }, "50");
                this._fontScaleX = valueOrDefault(template, "ScaleX", parseFloat, function (value) {
                    return !isNaN(value);
                }, "100") / 100;
                this._fontScaleY = valueOrDefault(template, "ScaleY", parseFloat, function (value) {
                    return !isNaN(value);
                }, "100") / 100;
                this._letterSpacing = valueOrDefault(template, "Spacing", parseFloat, function (value) {
                    return !isNaN(value);
                }, "0");
                this._rotationZ = valueOrDefault(template, "Angle", parseFloat, function (value) {
                    return !isNaN(value);
                }, "0");
                this._primaryColor = valueOrDefault(template, "PrimaryColour", function (str) {
                    return parser.parse(str, "colorWithAlpha");
                }, null, "&H0000FFFF");
                this._secondaryColor = valueOrDefault(template, "SecondaryColour", function (str) {
                    return parser.parse(str, "colorWithAlpha");
                }, null, "&H00000000");
                this._outlineColor = valueOrDefault(template, "OutlineColour", function (str) {
                    return parser.parse(str, "colorWithAlpha");
                }, null, "&H00000000");
                this._shadowColor = valueOrDefault(template, "BackColour", function (str) {
                    return parser.parse(str, "colorWithAlpha");
                }, null, "&H00000000");
                this._outlineThickness = valueOrDefault(template, "Outline", parseFloat, function (value) {
                    return !isNaN(value);
                }, "1");
                this._borderStyle = valueOrDefault(template, "BorderStyle", parseInt, function (value) {
                    return !isNaN(value);
                }, "1");
                this._shadowDepth = valueOrDefault(template, "Shadow", parseFloat, function (value) {
                    return !isNaN(value);
                }, "1");
                this._alignment = valueOrDefault(template, "Alignment", parseInt, function (value) {
                    return !isNaN(value);
                }, "2");
                this._marginLeft = valueOrDefault(template, "MarginL", parseFloat, function (value) {
                    return !isNaN(value);
                }, "80");
                this._marginRight = valueOrDefault(template, "MarginR", parseFloat, function (value) {
                    return !isNaN(value);
                }, "80");
                this._marginVertical = valueOrDefault(template, "MarginV", parseFloat, function (value) {
                    return !isNaN(value);
                }, "35");
            }
    ...
    function (module, exports) {
        ...
        var MoveInstruction = function () {
            function MoveInstruction(_x, _y) {
                this._x = _x;
                this._y = _y;
            }
        ...
        var LineInstruction = function () {
            function LineInstruction(_x, _y) {
                this._x = _x;
                this._y = _y;
            }
        ...
        var CubicBezierCurveInstruction = function () {
            function CubicBezierCurveInstruction(_x1, _y1, _x2, _y2, _x3, _y3) {
                this._x1 = _x1;
                this._y1 = _y1;
                this._x2 = _x2;
                this._y2 = _y2;
    ...
    function (module, exports, __webpack_require__) {
        ...
        var ManualClock = function () {
            function ManualClock() {
                 ...
                 */
                this._eventListeners = new map.Map();
            }
            /**
        ...
        var VideoClock = function () {
             ...
             * @private
             */
            VideoClock.prototype._onTimerTick = function (timeStamp) {
                var _this = this;
                if (!this._enabled) {
                    return;
                }
    ...
    function (module, exports, __webpack_require__) {
        var RendererSettings = __webpack_require__(18);
        var globalSettings = __webpack_require__(1);
        /**
        ...
        var NullRenderer = function () {
            function NullRenderer(_ass, _clock, settings) {
                var _this = this;
                this._ass = _ass;
                this._clock = _clock;
    ...
    function (module, exports, __webpack_require__) {
        ...
        var clocks = __webpack_require__(15);
        var VideoClock = clocks.VideoClock;
        var WebRenderer = __webpack_require__(19);
        /**
        ...
        var DefaultRenderer = function (_super) {
            ...
            function DefaultRenderer(_video, ass, settings) {
                _super.call(this, ass, new VideoClock(_video), document.createElement("div"), settings);
                this._video = _video;
    ...
    function (module, exports, __webpack_require__) {
        ...
        module.exports = RendererSettings;
    }, /* 19 */
    function (module, exports, __webpack_require__) {
        var __extends = this.__extends || function (d, b) {
            for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p];
        ...
        var AnimationCollection = __webpack_require__(21);
        var DrawingStyles = __webpack_require__(22);
        var Keyframe = __webpack_require__(23);
        var SpanStyles = __webpack_require__(24);
        var clocks = __webpack_require__(15);
        var EventSource = clocks.EventSource;
        var NullRenderer = __webpack_require__(16);
        var parts = __webpack_require__(7);
        var globalSettings = __webpack_require__(1);
        var mixin = __webpack_require__(20);
        var map = __webpack_require__(6);
        ...
        var WebRenderer = function (_super) {
            ...
            function WebRenderer(ass, clock, _libjassSubsWrapper, settings) {
                var _this = this;
                _super.call(this, ass, clock, function () {
                    if (!(_libjassSubsWrapper instanceof HTMLDivElement)) {
                        var temp = settings;
                        settings = _libjassSubsWrapper;
                        _libjassSubsWrapper = temp;
                ...
                this._libjassSubsWrapper = _libjassSubsWrapper;
                this._layerWrappers = [];
                this._layerAlignmentWrappers = [];
                this._currentSubs = new map.Map();
                this._preRenderedSubs = new map.Map();
                // EventSource members
                /**
                 * @type {!Map.<T, !Array.<Function>>}
                 */
                ...
                urlsToPreload.forEach(function (url) {
                    xhrPromises.push(new promise.Promise(function (resolve) {
                        var xhr = new XMLHttpRequest();
                ...
                promise.Promise.all(xhrPromises).then(function () {
                    if (globalSettings.debugMode) {
            ...
            WebRenderer.prototype.preRender = function (dialogue) {
                ...
                var startNewSpan = function (addNewLine) {
                    ...
                    currentAnimationCollection = new AnimationCollection(_this);
                ...
                dialogue.parts.forEach(function (part) {
                    if (part instanceof parts.Italic) {
                        ...
                        startNewSpan(false);
                        currentAnimationCollection.add("step-end", [ new Keyframe(0, new map.Map([ [ "color", currentSpanStyles.secondaryColor.withAlpha(currentSpanStyles.secondaryAlpha).toString() ] ])), new Keyframe(karaokeTimesAccumulator, new map.Map([ [ "color", currentSpanStyles.primaryColor.withAlpha(currentSpanStyles.primaryAlpha).toString() ] ])) ]);
                        ...
                        currentSpanStyles.reset(_this.ass.styles.get(part.value));
                    } else if (part instanceof parts.Position) {
                        sub.style.position = "absolute";
                        sub.style.left = "" + (_this._scaleX * part.x).toFixed(3) + "px";
                        sub.style.top = "" + (_this._scaleY * part.y).toFixed(3) + "px";
                    } else if (part instanceof parts.Move) {
                        sub.style.position = "absolute";
                        dialogueAnimationCollection.add("linear", [ new Keyframe(0, new map.Map([ [ "left", "" + (_this._scaleX * part.x1).toFixed(3) + "px" ], [ "top", "" + (_this._scaleY * part.y1).toFixed(3) + "px" ] ])), new Keyframe(part.t1, new map.Map([ [ "left", "" + (_this._scaleX * part.x1).toFixed(3) + "px" ], [ "top", "" + (_this._scaleY * part.y1).toFixed(3) + "px" ] ])), new Keyframe(part.t2, new map.Map([ [ "left", "" + (_this._scaleX * part.x2).toFixed(3) + "px" ], [ "top", "" + (_this._scaleY * part.y2).toFixed(3) + "px" ] ])), new Keyframe(dialogue.end - dialogue.start, new map.Map([ [ "left", "" + (_this._scaleX * part.x2).toFixed(3) + "px" ], [ "top", "" + (_this._scaleY * part.y2).toFixed(3) + "px" ] ])) ]);
                    } else if (part instanceof parts.Fade) {
                        dialogueAnimationCollection.add("linear", [ new Keyframe(0, new map.Map([ [ "opacity", "0" ] ])), new Keyframe(part.start, new map.Map([ [ "opacity", "1" ] ])), new Keyframe(dialogue.end - dialogue.start - part.end, new map.Map([ [ "opacity", "1" ] ])), new Keyframe(dialogue.end - dialogue.start, new map.Map([ [ "opacity", "0" ] ])) ]);
                    } else if (part instanceof parts.ComplexFade) {
                        dialogueAnimationCollection.add("linear", [ new Keyframe(0, new map.Map([ [ "opacity", part.a1.toFixed(3) ] ])), new Keyframe(part.t1, new map.Map([ [ "opacity", part.a1.toFixed(3) ] ])), new Keyframe(part.t2, new map.Map([ [ "opacity", part.a2.toFixed(3) ] ])), new Keyframe(part.t3, new map.Map([ [ "opacity", part.a2.toFixed(3) ] ])), new Keyframe(part.t4, new map.Map([ [ "opacity", part.a3.toFixed(3) ] ])), new Keyframe(dialogue.end - dialogue.start, new map.Map([ [ "opacity", part.a3.toFixed(3) ] ])) ]);
    ...
    function (module, exports, __webpack_require__) {
        ...
        var AnimationCollection = function () {
            function AnimationCollection(renderer) {
                ...
                this._animationDelays = new map.Map();
    ...
    function (module, exports, __webpack_require__) {
        var domParser = __webpack_require__(25);
        var parts = __webpack_require__(7);
        /**
        ...
        var DrawingStyles = function () {
            function DrawingStyles(_outputScaleX, _outputScaleY) {
                this._outputScaleX = _outputScaleX;
                this._outputScaleY = _outputScaleY;
                this._scale = 1;
            ...
            DrawingStyles.prototype.toSVG = function (drawingInstructions, fillColor) {
                ...
                drawingInstructions.instructions.forEach(function (instruction) {
                    if (instruction instanceof parts.drawing.MoveInstruction) {
                        path += " M " + instruction.x + " " + (instruction.y + _this._baselineOffset);
                        bboxWidth = Math.max(bboxWidth, instruction.x);
                        bboxHeight = Math.max(bboxHeight, instruction.y + _this._baselineOffset);
                    } else if (instruction instanceof parts.drawing.LineInstruction) {
                        path += " L " + instruction.x + " " + (instruction.y + _this._baselineOffset);
                        bboxWidth = Math.max(bboxWidth, instruction.x);
                        bboxHeight = Math.max(bboxHeight, instruction.y + _this._baselineOffset);
                    } else if (instruction instanceof parts.drawing.CubicBezierCurveInstruction) {
                        path += " C " + instruction.x1 + " " + (instruction.y1 + _this._baselineOffset) + ", " + instruction.x2 + " " + (instruction.y2 + _this._baselineOffset) + ", " + instruction.x3 + " " + (instruction.y3 + _this._baselineOffset);
                        bboxWidth = Math.max(bboxWidth, instruction.x1, instruction.x2, instruction.x3);
                        bboxHeight = Math.max(bboxHeight, instruction.y1 + _this._baselineOffset, instruction.y2 + _this._baselineOffset, instruction.y3 + _this._baselineOffset);
                    }
                });
    ...
    function (module, exports) {
        ...
        var Keyframe = function () {
            function Keyframe(_time, _properties) {
                this._time = _time;
    ...
    function (module, exports, __webpack_require__) {
        ...
        var SpanStyles = function () {
            function SpanStyles(renderer, dialogue, _scaleX, _scaleY, _settings, _fontSizeElement, _svgDefsElement) {
                this._scaleX = _scaleX;
                this._scaleY = _scaleY;
                this._settings = _settings;
                this._fontSizeElement = _fontSizeElement;
                this._svgDefsElement = _svgDefsElement;
            ...
            SpanStyles._getFontSize = function (fontFamily, lineHeight, fontSizeElement) {
                ...
                if (existingFontSizeMap === undefined) {
                    SpanStyles._fontSizeCache.set(fontFamily, existingFontSizeMap = new map.Map());
                }
