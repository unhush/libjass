...
/* libjass.settings.debugMode and libjass.settings.verboseMode are two properties that can be set to true to have libjass print some debug
 * information. This code sets them based on the querystring of the current page.
 */
libjass.settings.debugMode = (location.search === "?debug") || (location.search === "?verbose");
libjass.settings.verboseMode = (location.search === "?verbose");
